...
import { FaEdit, FaTrash, FaTimes } from "react-icons/fa"; // Import close icon

const Exams = () => {
  const [exams, setExams] = useState([
    { id: 1, title: "عنوان الاختبار 1" },
    { id: 2, title: "عنوان الاختبار 2" },
    { id: 3, title: "عنوان الاختبار 3" },
  ]);
  ...
  const closeModal = () => {
    ...
    setNewExamTitle(""); // Reset input field
  };
            ...
            {exams.map((exam) => (
              <div key={exam.id} style={rowStyle}>
                ...
                <div style={buttonContainerStyle}>
                  <button style={editButtonStyle}><FaEdit /> تعديل</button>
        ...
        <div style={overlayStyle}>
          <div style={modalStyle}>
            ...
            <div style={buttonContainer}>
              ...
              <button onClick={handleAddExam} style={addButtonStyle}>إضافة اختبار +</button>
            </div>
          </div>
        </div>
      )}
