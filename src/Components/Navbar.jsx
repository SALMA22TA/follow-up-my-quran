...
const Navbar = () => {
  ...
  const navLinks = [
    { text: 'الرئيسية', sectionId: 'hero' },
    { text: 'معلومات عنا', sectionId: 'about' },
    { text: 'مميزاتنا', sectionId: 'features' },
    { text: 'المعلمون', sectionId: 'teachers' },
    { text: 'آراء الطلاب', sectionId: 'testimonials' },
